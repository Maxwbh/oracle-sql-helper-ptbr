...
--
-- Cenário típico: página de geração de PDF (ex: declaração IRPF):
...
--==============================================================================
-- 5. Validação de documento via hash + key (caso típico: validação de documento autenticado)
--==============================================================================

-- Cenário: documento gerado tem URL pública para validação
-- URL: https://example.gov.br/ords/api/validar?key=ab12cd34-ef56gh78
